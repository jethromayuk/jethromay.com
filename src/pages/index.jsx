...
function SocialLink({ icon: Icon, ...props }) {
  return (
    <Link className="group -m-1 p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded-sm" target="_blank" rel="noopener noreferrer" {...props}>
