...
function SocialLink({ icon: Icon, ...props }) {
  return (
    <Link className="group -m-2 p-2 min-h-[44px] min-w-[44px] flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded-sm" target="_blank" rel="noopener noreferrer" {...props}>
