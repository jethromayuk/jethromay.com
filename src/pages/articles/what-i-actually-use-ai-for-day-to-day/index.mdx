...
export const meta = {
  ...
  hook: `I use AI every day. Not in a vague, exploratory way — in a concrete, this-is-now-part-of-how-I-work way.

AI handles the repetitive parts, I handle the decisions. The split works.

What it still can't do is understand the business problem or know when something is technically correct but wrong for the context. That's still the work.`,
