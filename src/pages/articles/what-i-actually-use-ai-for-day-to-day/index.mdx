...
export const meta = {
  ...
  hook: `I use AI every day — not in a vague, exploratory way. In a concrete, this-is-part-of-how-I-work way.

AI handles the repetitive parts, I handle the decisions.

What it can't do: understand the business problem, or know when technically correct means wrong for the context. That's still the work.`,
