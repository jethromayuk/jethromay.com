  ...
  return (
    <li>
      <Popover.Button
        as="a"
        href={href}
        className="flex min-h-[44px] items-center rounded-md py-3 focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:outline-hidden"
      >
        {children}
      </Popover.Button>
    </li>
          ...
          >
            <div className="flex flex-row-reverse items-center justify-between">
              <Popover.Button
                ...
                className="-m-2 flex min-h-[44px] min-w-[44px] items-center justify-center p-2"
              >
  ...
  return (
    <li>
      <a
        href={href}
        className={clsx(
          'relative block rounded-md px-3 py-2 transition focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:outline-hidden',
          isActive
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-linear-to-r from-teal-500/0 via-teal-500/60 to-teal-500/0 dark:from-teal-400/0 dark:via-teal-400/60 dark:to-teal-400/0" />
        )}
      </a>
    </li>
  )
...
function DesktopNavigation({
  pathname,
  ...props
}: { pathname: string } & ComponentProps<'nav'>) {
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem
          href="/articles"
          isActive={pathname === '/articles' || pathname.startsWith('/articles/')}
        >
          Articles
        </NavItem>
        ...
        <NavItem href="/uses" isActive={pathname === '/uses'}>
          Uses
        </NavItem>
      </ul>
    </nav>
...
function ModeToggle() {
  ...
  return (
    <button
      ...
      className="group rounded-full bg-white/90 px-3 py-2 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur-sm transition focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:outline-hidden dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20"
      onClick={toggleMode}
    >
...
// Inner container reproduced inline so this island doesn't pull a server component.
function Container({
  className,
  children,
  style,
  ...
  return (
    <div className={clsx('sm:px-8', className)} style={style}>
