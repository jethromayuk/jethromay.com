...
import AuditWidget from '@/components/AuditWidget.astro'

I launched [AuditZap](https://auditzap.io) today. It's a website audit tool that runs 40 checks across SEO, performance, and site health, and uses AI to generate fix instructions specific to your CMS. WordPress, Shopify, Webflow, whatever you're running.
...
<AuditWidget class="my-8" />

If you'd rather run one check than a whole audit, the same crawler powers the free [broken link checker](https://auditzap.io/tools/broken-link-checker), which needs no signup at all.
