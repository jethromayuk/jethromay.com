...
description: A useful addition to the Laravel framework was added recently, which allows for a cleaner syntax when retrieving items via a belongsTo relationship.
---
