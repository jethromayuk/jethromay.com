...
description: Sometimes you might need to test Laravel mails using the command line, to see if they are being sent/received, use this method to simplify testing.
---
...
![Screenshot of a successfully received test email in an email client](/articles/successful-email.png)
